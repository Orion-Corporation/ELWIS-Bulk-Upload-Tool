...
def convert_sdf_to_cdxml(input_sdf, output_cdxml, ensure_3d=True):
    ...
    if not obConversion.WriteFile(mol, output_cdxml):
        print(f"Error: Could not write the output file '{output.cdxml}'")
        return

    print(f"Successfully converted '{input_sdf}' to '{output_cdxml}'")

# Replace 'input.sdf' and 'output.cdxml' with your actual file names
convert_sdf_to_cdxml('/home/robert/ERAT/ENAMINE/45841679_FL10231460_Orion_2.SDF', 'output.cdxml', ensure_3d=False)
